...
const url5 = '../php/traerHsbcy.php';
const url6 = '../php/registrarPagosy.php';
const url7 = '../php/checadosy.php';
...
const traerIngreso = async () => {
    ...
    const ingresoMoneda = new Intl.NumberFormat().format(ingresoMes);
    seleccionarIngreso.textContent = `$ ${ingresoMoneda}`;
}

const irHsbc = () => {
    window.location.href = '../html/yanhsbc.html';
}
